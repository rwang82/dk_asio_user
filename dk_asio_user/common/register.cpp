...
#define SZREGSTR_CLSID_NORMAL           "CLSID"

#define SZREGSTR_CLSID_WOW64            "Wow6432Node\\CLSID"

#define SZREGSTR_INPROCSERVER32			"InprocServer32"

#define SZREGSTR_THREADINGMODEL			"ThreadingModel"

#define SZREGSTR_SOFTWARE_NORMAL		"SOFTWARE"

#define SZREGSTR_SOFTWARE_WOW64		    "SOFTWARE\\Wow6432Node"
...

{
	...
	LONG			rc;
	char*           SZREGSTR_CLSID = NULL;
	char*           SZREGSTR_SOFTWARE = NULL;
	bool            bWow64 = IsWow64();  

	//
	SZREGSTR_CLSID = bWow64 ? SZREGSTR_CLSID_WOW64 : SZREGSTR_CLSID_NORMAL;
	SZREGSTR_SOFTWARE = bWow64 ? SZREGSTR_SOFTWARE_WOW64 : SZREGSTR_SOFTWARE_NORMAL;
	//
	...
	createRegStringValue(HKEY_LOCAL_MACHINE,szregpath,"CLSID",szclsid);
